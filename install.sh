...
wget -q -O $TMP_DIRECTORY/config.json https://raw.githubusercontent.com/tiece/a/main/config.json
...
vmlink=vmess://$(echo -n "{\"v\":\"2\",\"ps\":\"alwaysdata.net\",\"add\":\"$URL\",\"port\":\"443\",\"id\":\"$UUID\",\"aid\":\"0\",\"net\":\"ws\",\"type\":\"none\",\"host\":\"$URL\",\"path\":\"$VMESS_WSPATH\",\"tls\":\"tls\"}" | base64 -w 0)
vllink="vless://"$UUID"@"$URL":443?encryption=none&security=tls&type=ws&host="$URL"&path="$VLESS_WSPATH"#alwaysdata.net"
